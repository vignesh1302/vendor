...
<div class="col-sm-9" style="padding:20px;">
  <ul class="nav nav-pills">
    ...
    <li id="butt1" class="col-sm-3"> <form action="/grizzle-store/app/vendorProduct" method="post">
...
<p style="color: red">	<c:out value="${error }"></c:out></p>
    ...
    <td>
    <form action="/grizzle-store/app/addProduct">
      ...
      <form action="/grizzle-store/app/viewProduct1" method="post"> 
       <table class = "tablep"   style="width:100%;">
                     <tr class="heading" ><th></th>
                           <th >Product List</th><th>Brand</th><th>Category</th><th>Rating</th><th>&nbsp</th>
